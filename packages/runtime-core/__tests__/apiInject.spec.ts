...
import { hasInjectionContext, InjectionKey } from '../src/apiInject'
import { reactive, readonly, ref, Ref } from '@pvue/reactivity'
...
describe('api: provide/inject', () => {
  ...
  it.skip('reactivity with readonly objects', async () => {
    const rootState = reactive({ count: 1 })
