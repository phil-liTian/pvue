...
import { ComponentPublicInstance } from '../src/componentPublicInstance'
...
describe('component: emit', () => {
  ...
  test.skip('does not emit after unmount', async () => {
    const fn = vi.fn()
    const Foo = defineComponent({
      emits: ['closing'],
      async beforeUnmount() {
  ...
  test.skip('merge string array emits', async () => {
  ...
  test.skip('merge object emits', async () => {
