/*
 * @Author: phil
 * @Date: 2025-08-12 17:08:54
 */
import { h, render, nodeOps, createApp } from '@pvue/runtime-test'
import { ComponentInternalInstance, getCurrentInstance } from '../src/component'
import { shallowReadonly } from '@pvue/reactivity'
import { ComponentOptions } from '../src/componentOptions'
...
describe('component: proxy', () => {
  ...
  test.skip('public properties', async () => {
    ...
    expect(instanceProxy.$props).toStrictEqual(shallowReadonly(instance!.props))
  ...
  test('allow test runner spying on proxy methods with Object.defineProperty', () => {
    ...
    const spy = vitest.spyOn(instanceProxy, 'toggle')
  ...
  test.skip('defineProperty on public instance proxy should work with SETUP,DATA,CONTEXT,PROPS', () => {
    // #5417
    let instanceProxy: any
    const Comp = {
      props: ['fromProp'],
  ...
  test.skip('should not warn declared but absent props', () => {
    const Comp = {
      props: ['test'],
      render(this: any) {
        return this.test
  ...
  test.skip('should allow symbol to access on render', () => {
    const Comp = {
      render() {
  ...
  test.skip('should prevent mutating script setup bindings', () => {
