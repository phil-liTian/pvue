...
describe('renderer: component', () => {
  ...
  test.skip('instance.$el should be exposed to watch options', async () => {
  ...
  test.skip('component child updating parent state in pre-flush should trigger parent re-render', async () => {
    const outer = ref(0)
    const App = {
      setup() {
        const inner = ref(0)
  ...
  test.skip('child only updates once when triggered in multiple ways', async () => {
    const a = ref(0)
    const calls: string[] = []
  ...
  test.skip(`an earlier update doesn't lead to excessive subsequent updates`, async () => {
  ...
  test.skip('should pause tracking deps when initializing legacy options', async () => {
  ...
  test.skip('the component VNode should be cloned when reusing it', () => {
    const App = {
      render() {
        const c = [h(Comp)]
        return [c, c, c]
  ...
  test.skip('child component props update should not lead to double update', async () => {
    const text = ref(0)
    const spy = vi.fn()
