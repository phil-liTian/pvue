...
describe('renderer: fragment', () => {
  ...
  test.skip('`template` keyed fragment w/ comment + hoisted node', () => {
    const root = nodeOps.createElement('div')
  ...
  test.skip('`template` fragment w/ render function', () => {
  ...
  test.skip('`template` fragment w/ render function + keyed vnode', () => {
    const renderFn = (vnode: VNode) => {
      return (
        openBlock(),
        createBlock(
  ...
  test.skip('`template` keyed fragment w/ text', () => {
    const root = nodeOps.createElement('div')
