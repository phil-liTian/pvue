...
describe('api: createApp', () => {
  ...
  describe('config.isNativeTag', () => {
    ...
    test.skip('Component.directives', () => {
      const Root = {
        directives: {
          bind: () => {},
        },
  ...
  test.skip('config.optionMergeStrategies', () => {
    let merged: string
  ...
  test.skip('return property "_" should not overwrite "ctx._", __isScriptSetup: true', () => {
    const Comp = defineComponent({
      setup() {
        return {
          _: ref(0), // return property "_" should not overwrite "ctx._"
  ...
  test.skip('flush order edge case on nested createApp', async () => {
    const order: string[] = []
    const App = defineComponent({
      setup(props) {
