...
describe('vnode', () => {
  ...
  test.skip('cloneVNode ref normalization', () => {
  ...
  test.skip('cloneVNode ref merging', () => {
    const mockInstance1 = { type: {} } as any
    const mockInstance2 = { type: {} } as any
  ...
  describe('dynamic children', () => {
    ...
    // })
    // // #5657
    test.skip('error of slot function execution should not affect block tracking', () => {
